...
const sum = (...numeros) => numeros.reduce((total, numero)=> total + numero);
console.log(sum(2,3,4,1,5,2, 2));

// 3 - Escreva a função personLikes, que dado um objeto de parâmetro que 
// representa uma pessoa, retorna todos os gostos daquela pessoa, conforme 
// mostrado abaixo:
...
// daquela estação. A partir deste objeto, desestruture as estações do ano e espalhe-as em 
// um array de meses do ano.
